...
void CheckSideSide::Execute()
{
	...
	bool acheck = (pos <= (arm.get()->GetEncoderPositionForAutomationOfArm(cam.get()->distanceToBlob()) + 5)) && (pos >= (arm.get()->GetEncoderPositionForAutomationOfArm(cam.get()->distanceToBlob()) - 5));
