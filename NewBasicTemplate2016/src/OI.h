...
public:
	...
	const int CONTROL_COLLECTION_IN[2] = {BBOX, LINE_BUMPUP};
	const int CONTROL_COLLECTION_OUT[2] = {BBOX, LINE_BUMPDOWN};

	const int CONTROL_SHOOTER_KICKER_KICK[2] = {BBOX, SILVER_SWITCH};
	const int CONTROL_SHOOTER_KICKER_RESET[2] = {BBOX, RED_SWITCH};
	...
	const int CONTROL_SHOOT[2] = {BBOX, SILVER_TOGGLE};
